...
:: Open a new Command Prompt, navigate to Downloads, run the Python script, and forcefully close the window after execution
start "" cmd /c "cd /d %USERPROFILE%\Downloads && python ChromeDriver_Download.py && exit"
goto menu
